<template>
  <div class="n-Info">
    <scroll class="scCont" ref="scroll">
      ...
      <div class="n-Iyu">
        <div class="n-Itg">
          {{mainList && mainList[2].oneTitle}}
          <p>{{mainList && mainList[2].lessTitle}}</p>
        </div>
      ...
      <div class="n-Iuh">
        <div class="n-Ifo">
          ...
          <span class="pure">{{mainList && mainList[2].author}}</span>
          <span class="thr-op">{{mainList && mainList[2].seeTimes}}万推荐></span>
        </div>
      </div>

      <img class="n-Ione" :src="mainList && mainList[2].img" />
