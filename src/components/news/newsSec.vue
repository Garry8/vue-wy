<template>
  <div class="n-Info">
    <scroll class="scCont" ref="scroll">
      ...
      <div class="n-Iyu">
        <div class="n-Itg">
          {{mainList && mainList[1].oneTitle}}
          <p>{{mainList && mainList[1].lessTitle}}</p>
        </div>
      ...
      <div class="n-Iuh">
        <div class="n-Ifo">
          ...
          <span class="pure">{{mainList && mainList[1].author}}</span>
          <span class="thr-op">{{mainList && mainList[1].seeTimes}}万推荐></span>
        </div>
      </div>

      <img class="n-Ione" :src="mainList && mainList[1].img" />
